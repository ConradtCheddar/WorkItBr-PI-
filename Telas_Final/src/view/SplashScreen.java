 ...
 * <p>
 * Responsável por: exibir o logo e nome da aplicação, mostrar uma barra de
 * progresso visual durante a inicialização, exibir mensagens de status das
 * etapas de carga, fornecer feedback visual profissional ao usuário durante o
 * startup, e fechar-se automaticamente quando a inicialização é concluída.
 * </p>
 */
public class SplashScreen extends JWindow {
	...
	// Label que exibe mensagens textuais sobre o status atual ("Inicializando...",
	// etc.)
	 ...
	 * <p>
	 * Inicializa todos os componentes visuais, define cores e estilos, organiza o
	 * layout e centraliza a janela na tela.
	 * </p>
	 */
	public SplashScreen() {
		...
		// Adiciona margem interna de 40 pixels (topo/baixo) e 60 pixels
		// (esquerda/direita)
	 ...
	 * <p>
	 * Executa a atualização de forma segura na thread de interface (Event Dispatch
	 * Thread) para evitar problemas de concorrência.
	 * </p>
	 * 
	 * @param progress valor entre 0 e 100 indicando o percentual de conclusão
	 * @param status   mensagem descritiva da etapa atual ("Carregando banco...",
	 *                 etc.)
	 */
	 ...
	 * <p>
	 * Aguarda um pequeno tempo antes de fechar para suavizar a transição visual
	 * entre a splash screen e a janela principal.
	 * </p>
	 */
	 ...
	 * <p>
	 * Permite controlar o tempo de espera antes de fechar, útil para dar ao usuário
	 * tempo de ver a conclusão da barra de progresso.
	 * </p>
	 * 
