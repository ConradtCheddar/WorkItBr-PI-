 ...
 * <p>
 * Responsável por: criar uma representação visual personalizada para cada serviço na lista,
 * exibir informações como nome, modalidade, descrição e valor formatados, aplicar cores
 * e estilos específicos para estados selecionado/não-selecionado, e organizar os elementos
 * visualmente de forma hierárquica e legível.
 * </p>
 */
public class ServicoListCellRenderer extends JPanel implements ListCellRenderer<Servico> {
    ...
    public ServicoListCellRenderer() {
        // Define BorderLayout como gerenciador de layout principal (centro e lateral direita)
