...
public class CadastroController {
	...
	public CadastroController(TelaCadastro view, UsuarioDAO model, Navegador navegador){
		...
		this.view.cadastrar(e ->{
			...
			Usuario u = new Usuario(email, usuario, cpf, telefone, senha1, null, this.view.getRdbtnContratado().isSelected(), this.view.getRdbtnContratante().isSelected(), false, null);
