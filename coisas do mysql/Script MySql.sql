...
CREATE TABLE IF NOT EXISTS Servico (
    ...
    CONSTRAINT fk_contratante FOREIGN KEY (id_contratante) REFERENCES Login(idLogin) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_contratado FOREIGN KEY (id_contratado) REFERENCES Login(idLogin) ON DELETE SET NULL ON UPDATE CASCADE
);
